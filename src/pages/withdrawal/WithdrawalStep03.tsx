...
import { addWithdrawal } from "../../services/accouts.services.tsx";
import { PDFDownloadLink } from "@react-pdf/renderer";
import { WithdrawalTemplate } from "./WithdrawalTemplate.tsx";

const WithdrawalStep03 = () => {
  ...
  const execute = async () => {
    const ok = await addWithdrawal(2542, accountSelected, {
      id: 0,
...
export default WithdrawalStep03;